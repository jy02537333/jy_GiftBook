...
import pri.zxw.library.tool.ScreenDisplay;

public final class DialogSheetzAction {
	...
	public DialogSheetzAction builder() {
		// 获取Dialog布局
		View view = LayoutInflater.from(activity).inflate(R.layout.dialog_sheet, null);

		// 设置Dialog最小宽度为屏幕宽度
		view.setMinimumWidth(ScreenDisplay.getScreenWidth(activity));
	...
	public DialogSheetzAction setTitle(String title) {
		showTitle = true;
	...
	public DialogSheetzAction setCancelable(boolean cancel) {
		dialog.setCancelable(cancel);
		return this;
	}

	public DialogSheetzAction setCanceledOnTouchOutside(boolean cancel) {
	 ...
	 * @return
	 */
	public DialogSheetzAction addSheetItem(String strItem, SheetItemColor color, OnSheetItemClickListener listener) {
	...
	private void setSheetItems() {
		...
		if (size >= 7) {
			...
			params.height = ScreenDisplay.getScreenHeight(activity) / 2;
